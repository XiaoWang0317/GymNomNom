...
public class NutritionCalculator {
    public static int nutritions(int[] nutrition, int age, int sex, int fitnessType){
        int[] recommendedTemp;
    ...
    public static void main (String[] args){
        ...
        int s = NutritionCalculator.nutritions(i, 52, 0,1);
        int[] i1 = {30, 85, 500, 2000, 96, 130};
        int s1 = NutritionCalculator.nutritions(i1, 34, 0,1);
        int[] i2 = {60, 55, 700, 1800, 46, 130};
        int s2 = NutritionCalculator.nutritions(i2, 18, 0,1);
